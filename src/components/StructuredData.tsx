    ...
    case "category":
      if (data?.category && data?.projectCount) {
        structuredData = {
          ...
          url: `https://openapps.sh/categories/${data.category.toLowerCase()}`,
          mainEntity: {
            "@type": "ItemList",
          ...
          breadcrumb: {
            ...
            itemListElement: [
              ...
              },
              {
                ...
                position: 2,
                name: "Categories",
                item: "https://openapps.sh/categories",
              },
              {
                "@type": "ListItem",
                position: 3,
                name: data.category,
                item: `https://openapps.sh/categories/${data.category.toLowerCase()}`,
              },
            ],
          },
        };
  ...
  const structuredData = {
    ...
    itemListElement: [
      ...
      ...items.map((item, index) => ({
        "@type": "ListItem",
        position: index + 3,
        item: `https://openapps.sh/categories/${item.category.toLowerCase()}`,
        name: item.name,
      })),
    ],
  };

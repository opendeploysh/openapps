  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-neutral-50 dark:from-neutral-950 dark:to-neutral-900">
      ...
      <div className="container max-w-5xl mx-auto px-4 py-8">
        ...
        <div className="prose prose-neutral dark:prose-invert max-w-none mt-14">{mdxData?.content}</div>
        ...
        <div className="mt-8 p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <h4 className="font-medium text-blue-900 dark:text-blue-100 mb-1">Help improve this content</h4>
              <p className="text-sm text-blue-700 dark:text-blue-300 mb-3">
                Found an error or want to add more information about {project.name}? You can edit this page directly on
                GitHub.
              </p>
              <GitHubEditButton
